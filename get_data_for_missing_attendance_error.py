...
def get_student_name(anthology_api_key: str, anthology_base_url: str, student_id: str) -> str:
...
def get_course_info(canvas_bearer_token: str, canvas_base_url: str, canvas_term_id: int, anthology_course_ids: str):
