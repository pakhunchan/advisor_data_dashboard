...
async def get_graduation_hold_registration_hold_asynchronously(anthology_api_key: str, anthology_base_url: str, students: list[dict]) -> list[dict]:
    size_per_chunk = 10
...
async def get_graduation_and_registration_holds_from_api(anthology_api_key: str, anthology_base_url: str, student: dict, client: httpx.AsyncClient) -> dict:
    max_retries = 3
    base_delay = 2

    url = f"{anthology_base_url}/ds/campusnexus/StudentGroupMembers/CampusNexus.CheckStudentHoldGroup(studentId=1318)"
